...
def json_print():
    ...
    #ith open('nyt_data.txt', 'w') as outfile:  
       #json.dump(text, outfile)
       # print("opened")
    
    #with open('nyt_data.txt', 'w') as f:
        #json.dump(text, f)
    
    #with open("nyt_data", 'w', newline='') as file:
        #writer = csv.writer(file)     
        #write column titles
        #writer.writerow(['Critic', 'Review', 'Movie'])
        #write data
        #for rows in text:
            #print(rows)
            #writer.writerow(tuple(rows))
